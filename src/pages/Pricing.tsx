      ...
      <section className="relative bg-talon-sand/30 py-20">
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-talon-navy/80 animate-fade-in mb-4" style={{
            animationDelay: '200ms'
          }}>
              Thoughtfully curated wildlife experiences designed for the conscious luxury traveler.
            </p>
            <div className="inline-flex items-center gap-2 bg-talon-gold/10 px-4 py-2 rounded-full animate-fade-in" style={{
        ...
        <div className="container">
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
              ...
              return <div key={tier.name} className={`card-luxury p-6 text-center relative ${tier.popular ? 'ring-2 ring-talon-gold' : ''} animate-fade-in`} style={{
            ...
            {/* Comparison Table */}
            <div className="card-luxury overflow-hidden animate-fade-in" style={{
            animationDelay: '300ms'
              ...
              {features.map((feature, index) => <div key={feature.name} className={`grid grid-cols-1 md:grid-cols-4 gap-6 px-6 py-4 ${index % 2 === 0 ? 'bg-talon-sand/5' : 'bg-white'} border-b border-talon-sand/20 last:border-b-0`}>
            ...
            <div className="mt-12 space-y-4 text-center">
              <div className="bg-talon-sand/10 rounded-lg p-6 animate-fade-in" style={{
              animationDelay: '500ms'
                ...
                <div className="space-y-3 text-sm text-talon-navy/80">
                  ...
                  <p>Full service booking support may be available. Please inquire if you'd like help securing your chosen experience.</p>
                </div>
              </div>

              <p className="text-sm text-talon-navy/60 leading-relaxed animate-fade-in" style={{
