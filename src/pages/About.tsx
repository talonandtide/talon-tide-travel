        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="mb-4 animate-fade animate-delay-200">Still, I found myself dreaming of the wild and seeing the animals I worked with in their natural habitats. That dream is what sparked Talon & Tide. I built this company to bridge both worlds: thoughtfully crafted encounters at leading zoos and aquariums, and extraordinary wildlife tours that bring you face to face with nature on its own terms.
