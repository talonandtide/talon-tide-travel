  ...
  return <Layout>
      ...
      <section className="relative h-screen overflow-hidden">
        ...
        <div className="container relative z-10 h-full flex flex-col justify-center">
          <div className="max-w-md md:max-w-2xl">
            ...
            <p className="text-talon-ivory text-lg md:text-xl mb-10 max-w-xl font-light animate-fade-in drop-shadow-text tracking-wide" style={{
      ...
      <section className="py-24 bg-gradient-to-b from-white to-talon-sand/20">
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            ...
            image: "https://images.unsplash.com/photo-1485833077593-4278bba3f11f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2670&q=80",
            path: "/experiences"
          }].map((category, index) => <div key={index} className="group animate-fade" style={{
            animationDelay: `${index * 100}ms`
                ...
                <div className="relative overflow-hidden card-luxury h-full">
                  ...
                  <div className="p-8">
                    ...
                    <Link to={category.path} className="inline-flex items-center gap-2 text-sm text-talon-gold hover:text-talon-gold/80 transition-colors font-medium">
          ...
          <div className="text-center animate-fade">
            <p className="text-talon-green mb-6 text-2xl font-serif font-medium text-center">
              Not seeing your dream trip? That's the point. We don't sell packages - <span className="font-script text-script-lg text-talon-gold italic">we create them.</span>
            </p>
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-2 lg:order-2">
              <div className="relative">
                <img alt="Lindsay, founder of Talon & Tide" className="rounded-sm w-full h-auto object-cover animate-fade animate-delay-100" src="/lovable-uploads/91752c72-542b-4652-a411-d30016f1da40.jpg" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="container">
          ...
          }].map((step, index) => <div key={index} className="text-center animate-fade" style={{
            animationDelay: `${index * 100}ms`
          }}>
        ...
        <div className="container">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="relative h-[600px] overflow-hidden rounded-lg">
              {testimonials.map((testimonial, index) => <div key={testimonial.id} className={`absolute inset-0 transition-opacity duration-1000 ${currentTestimonial === index ? 'opacity-100' : 'opacity-0'}`}>
                  {/* Background Image */}
            ...
            <div className="flex justify-center space-x-2 mt-8">
              {testimonials.map((_, index) => <button key={index} onClick={() => setCurrentTestimonial(index)} className={`w-3 h-3 rounded-full transition-colors duration-300 ${currentTestimonial === index ? 'bg-talon-gold' : 'bg-talon-ivory/30'}`} />)}
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-talon-sand/30">
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {blogPosts.map((post, index) => <Link to={`/blog/${post.id}`} key={post.id} className="group animate-fade" style={{
            animationDelay: `${index * 100}ms`
          }}>
